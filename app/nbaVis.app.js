(function () {
    let nbaVisApp = angular.module('nbaVisApp', [
        'ngRoute',
        'ui.router',
        'ngAnimate',
        'ngResource',
    ...
    nbaVisApp.config(['$routeProvider', '$locationProvider', '$stateProvider', '$urlRouterProvider',
    ...
    nbaVisApp.controller('globalCtrl', ['$rootScope','$state', '$mdBottomSheet', '$http', function($rootScope, $state, $mdBottomSheet){
    ...
    nbaVisApp.controller('toolMenuCtrl', ['$rootScope', '$scope', '$mdBottomSheet', '$sessionStorage', '$window' , function ($rootScope, $scope, $mdBottomSheet, $sessionStorage, $window) {
    ...
    nbaVisApp.factory('globalService', ['$sessionStorage', '$http', function ($sessionStorage, $http) {
        let globalService = {};
        let teamColor ={
