(function () {
    angular.module('nbaVisApp')
        .constant('WEB_CONTENT_SERVICE',     'https://www.alukardo.top/django/pdp/')
        .constant('BOX_WEB_CONTENT_SERVICE', 'https://www.alukardo.top/django/playerd/')
        .factory('contentService', ['$http', 'WEB_CONTENT_SERVICE', 'BOX_WEB_CONTENT_SERVICE', function ($http, WEB_CONTENT_SERVICE, BOX_WEB_CONTENT_SERVICE) {
            let service = {};
